    ...
    return (
        ...
        >
            <Grid container sx={{ maxWidth: 450 }} justifyContent='center' alignItems='center'>
                <Grid item xs={12}>
                    <Box
                        sx={{ ...boxStyle, height: '7vh', fontSize: '1.5rem' }}
                        display='flex'
                        alignItems='center'
                ...
                <Grid item xs={12}>
                    <Box
                        sx={{ ...boxStyle, height: '9vh', paddingX: 2.5 }}
                        display='flex'
                        alignItems='center'
                        justifyContent='center'
                    >
                        <Grid container alignItems='center' sx={{ height: '100%' }}>
                            <Grid item xs={2.5}>目的地</Grid>
                            <Grid item xs={9.5}>
                                <Typography>緯度: {lat}<br /></Typography>
                ...
                <Grid item xs={12}>
                    <Box
                        sx={{ ...boxStyle, height: '5vh', paddingX: 3 }}
                        display='flex'
                        alignItems='center'
                        justifyContent='center'
                    >
                        <Typography variant='h6'>{distanceMessage || '近いです'}</Typography>
                    </Box>
                </Grid>
                <Grid item xs={12}>
                    <Box
                        sx={{ ...boxStyle, height: '9vh' }}
                        display='flex'
                        alignItems='center'
                        justifyContent='center'
                    >
                        <Grid container alignItems='center' sx={{ height: '100%', paddingX: 1.5 }}>
                            <Grid item xs={2.5}>現在地</Grid>
                            <Grid item xs={9.5}>
                                <Typography>緯度: {latitude}<br /></Typography>
